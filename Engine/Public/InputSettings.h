...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void ClearAxisMappings(bool bForceRebuildKeymaps);
    
    UFUNCTION(BlueprintCallable)
    void ClearActionMappings(bool bForceRebuildKeymaps);
    
    UFUNCTION(BlueprintCallable)
    void AddAxisMappings(const TArray<FInputAxisKeyMapping>& KeyMappings, bool bForceRebuildKeymaps);
    
    UFUNCTION(BlueprintCallable)
    void AddAxisMapping(const FInputAxisKeyMapping& KeyMapping, bool bForceRebuildKeymaps);
    
    UFUNCTION(BlueprintCallable)
    void AddActionMappings(const TArray<FInputActionKeyMapping>& KeyMappings, bool bForceRebuildKeymaps);
